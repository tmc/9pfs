...
//
// This is a vendored copy of github.com/tmc/apple/x/fskitbridge, kept here
// while that package is unreleased: it lives only on an extraction branch,
// and pinning a branch commit is worse than carrying the source. The copy
// builds against the published github.com/tmc/apple tag this module
// requires. Fixes belong upstream first; when the package ships in a tag,
// delete this directory and import it from there.
package fskitbridge
